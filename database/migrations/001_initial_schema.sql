...
CREATE TABLE IF NOT EXISTS customers (
    ...
    churn_risk_score NUMERIC(5, 2) DEFAULT 0.15,
    propensity_score NUMERIC(5, 2) DEFAULT 0.85,
...
CREATE TABLE IF NOT EXISTS hallmark_records (
    id VARCHAR(64) PRIMARY KEY,
    journey_id VARCHAR(64) REFERENCES journeys(id) ON DELETE CASCADE,
    assay_office VARCHAR(150) NOT NULL,
    certificate_number VARCHAR(100) UNIQUE NOT NULL,
    purity_verified VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS certificates (
    ...
    certificate_authority VARCHAR(50) NOT NULL,
    certificate_number VARCHAR(100) UNIQUE NOT NULL,
    item_title VARCHAR(255) NOT NULL,
    carat_weight NUMERIC(6, 3) NOT NULL,
    color_grade VARCHAR(20) NOT NULL,
    clarity_grade VARCHAR(20) NOT NULL,
    cut_grade VARCHAR(20) NOT NULL,
